...
contains
  ...
  subroutine UpdatePlantHydrLenVol(ccohort,site_hydr)
    ...
    real(r8) :: v_leaf_donate(1:n_hypool_leaf)   ! the volume that leaf will donate to xylem - Junyan added for grass hydro
    ...
    real(r8), parameter :: l2sap_vol_donate_frac = 0.5_r8   ! Junyan added for grass hydro
    ...
    ! Junyan changed the following code to calculate the above ground node
    ! volume
